                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <a href="contacto.php"> <button class="btn btn-productos btn-productos-oculto mont"
                                    id="prueba"> <strong>Contáctanos</strong></button></a>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 img-producto">
                        <img src="data:image/jpg;base64, <?php echo base64_encode($row['img']); ?>"
                            class="img-product-mostrar" alt="">
                    </div>
                </div>
                        ...
                        <div class="row text-left services">
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-01.png"
                                    ...
                                    <!--end media-->
                                    <p class="gray mt-10">Los cepillos de FOAMI se adaptan al contorno del auto y
                                        ofrecen un lavado profundo sin rayones. </p>
                                </a>
                            </div>
                            <!--col-end-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-02.png"
                                            alt=" Asesoría  Personalizada de Negocios">
                                        <div class="media-body">
                                    ...
                                    <p class="gray mt-10">Los turbo ventiladores trabajan a bajas revoluciones y un alto
                                        ...
                                        particular diseño 3D ofrece una eficiencia de secado excepcional en cualquier
                                        tipo de vehículo.</p>
                                </a>
                            </div>
                            <!--col-end-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-03.png"
                                            alt=" Asesoría  Personalizada de Negocios">
                                        <div class="media-body">
                                    ...
                                    <!--end media-->
                                    <p class="gray mt-10">Compuesto por 3 cepillos de tela absorbente, optimiza la
                                        acción de la cera aplicada tras el ciclo de aclarado, optimiza el secado y
                                        ofrece un brillo deslumbrante de forma totalmente automatizada. </p>
                                </a>
                            </div>
                            <!--col-end-->
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-04.png"
                                            alt=" Asesoría  Personalizada de Negocios">
                                        <div class="media-body">
                                            <h6 class="mt-0 mont"><strong> CERRAMIENTO INCLUIDO</strong></h6>
                                            <p class="light mt-0 mont"> LA SERIE MATIK’S INCLUYE EL CERRAMIENTO DEL
                                                TÚNEL</p>
                                        </div>
                                    </div>
                                    <!--end media-->
                                    <p class="gray mt-10">Todos los modelos de túnel de lavado incluyen la estructura de
                                        acero galvanizado del cerramiento, las cubiertas superiores y laterales que
                                        pueden ser de cristal, policarbonato o PVC se cotizan aparte. </p>
                                </a>
                            </div>
                            <!--col-end-->
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-05.png"
                                            alt=" Asesoría  Personalizada de Negocios">
                                        <div class="media-body">
                                    ...
                                    <p class="gray mt-10">Personaliza tu equipo con los diferentes colores, pictogramas,
                                        configuraciones y operaciones para hacer único y exclusivo el equipo de
                                        autolavado. </p>
                                </a>
                            </div>
                            <!--col-end-->
                            <div class="col-xs-12 col-sm-12 col-lg-12  left ">
                                <a href="servicio-asesoria" style="color:black">
                                    <div class="media">
                                        <img class="mr-3" src="images/icons/catalogo-06.png"
                                            alt=" Asesoría  Personalizada de Negocios">
                                        <div class="media-body">
                        ...
                        <div class="item-catalogo">
                            <a href="producto.php?id=<?php echo $row['id']; ?>">
                                <img src="data:image/jpg;base64, <?php echo base64_encode($row['img']); ?>" alt=""
                                    class="img-fluid imagenProducto">
                                <div class="text-item">
