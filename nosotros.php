            ...
            <div class="container">
                <div class="row text-left ">
                    <div class="col-xs-12 col-sm-12 col-lg-6 left">
                        ...
                        <p class="gray mt-10 mont">Somos la primera empresa Mexicana que diseña y ofrece a sus clientes
                            los mejores equipos de lavado automatizado de vehículos para México y Latinoamérica.
                            Los equipos GreenMatik son ensamblados en China en sinergia con el fabricante más innovador
                            de Asia, que tras 30 años de investigación continua para el desarrollo de nuevas tecnologías
                            aplicadas a la fabricación de túneles y puentes de lavado confiables y funcionales, le
                            permitió obtener en 2016 la Certificación internacional ISO 9001.</p>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-6  left ">
                        ...
                        <p class="gray mt-10 mont">Proporcionar a nuestros clientes equipos robustos de alto
                            rendimiento, con la mejor relación calidad-precio del mercado, y unos costes de
                            mantenimiento sorprendentemente bajos, que desde hace años satisfacen con éxito los mercados
            ...
            <div class="container">
                ...
                <div class="row mt-50">
                    ...
                    <div class="col-6 col-md-3 text-center">
                        ...
                        <p class="gray mont">Analizamos tus preferencias y objetivos de negocio, en base a ello
                            realizamos la cotización. </p>

                    </div>
                    <div class="col-6 col-md-3 text-center">
                        <img src="images/icons/about-03.png" alt="Paso 1 de nuestr proceso de diseño">
                        <h6 class="mt-20 mont"><strong>CONTRATO </strong></h6>
                        <p class="gray mont">Firmamos un contrato con fecha de entrega e instalación, se realiza el pago
                            del anticipo y se entregan los planos deobra civil a realizar. </p>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        ...
                        <p class="gray mont">Coordinación de fecha de inicio y final de obra civil por cuenta del
                            cliente o de GreenMatik si es un proyecto llave en mano. </p>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        ...
                        <p class="gray mont"> Una vez finalizada la obra civil, realizas el pago del segundo anticipo y
                            se procede la instalación de los equipos y accesorios.</p>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        ...
                        <p class="gray mont"> Una vez los equipos y accesorios han superado las pruebas, se realiza la
                            firma de entrega final y se realiza el pago final de los equipos y accesorios.</p>
