            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="images/bg1.png" alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="titulo-carousel">Invierte en un Negocio Rentable</h1>
                            <p class="white">Conoce nuestra increíble línea de productos 100% <br> Mexicana diseñada
                                para cuidar el medio ambiente y cuidar tu bolsillo.
                            </p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <div>
                                <a href="contacto.php"><button
                                        class="btn btn-border-white mont">Contáctanos</button></a>
                                <a href="catalogo.php"><button
                                        class="btn btn-blanco ml-10 mont"><strong>Catálogo</strong></button></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <p class=" text-center">
                            Bienvenidos a nuestra familia GreenMatik, donde encontraras las mejores soluciones para tu
                            negocio, con nuestro equipo y personal de alta calidad, nosotros te llevamos de la mano en
                ...
                <div class="row text-left services">
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-3  text-center">
                        <a href="#" style="color:black">
                            ...
                            <p class="gray">¿Eres una persona emprendedora, cuentas con un terreno o algún medio de
                                invertir inteligentemente en un autolavado y reducir costos?</p>
                        </a> </div>
                    <div class="col-xs-12 col-sm-6 col-lg-3  text-center">
                        <a href="llave-mano.php" style="color:black">
                            ...
                            <p class="gray">¿Buscas Invertir en un negocio rentable con recuperación de inversión en 18
                                meses?</p>
                        </a> </div>
                    <div class="col-xs-12 col-sm-6  col-lg-3  text-center">
                        <a href="catalogo.php" style="color:black">
                            ...
                            <p class="gray">¿Tienes una empresa de flotilla de vehículos, quieres mejorar tu
                                productividad, ahorrar tiempos y dinero
                                ?</p>
                        </a> </div>
                </div>
            </div>
        ...
        <section id="servicios" class="bg-gray">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <p class=" text-center">
                            En GreenMatik nos interesa que tu negocio sea rentable, es por ello que nosotros te llevamos
                            de la mano en todo el proceso de negocio y te ofrecemos los mejores equipos de México y
                            Latinoamérica.
                        </p>
                    </div>
                    <div class="col-xs-12 col-md-2"></div>
                ...
                <div class="row text-left mt-70">
                    <div class="col-xs-12 col-sm-6 col-lg-6  left mt-20">
                        <a href="servicio-asesoria" style="color:black">
                            <div class="media">
                                <img class="mr-3" src="images/icons/servicios-01.png"
                                    alt=" Asesoría  Personalizada de Negocios">
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-6  left mt-20">
                        <a href="servicio-garantias" style="color:black">
                            <div class="media">
                                <img class="mr-3" src="images/icons/servicios-02.png"
                                    alt=" Asesoría  Personalizada de Negocios">
                                <div class="media-body">
                                    <h6 class="mt-0"><strong> Garantías y Programas <br> Exclusivos Greenmatik</strong>
                                    </h6>
                                </div>
                            </div>
                            <p class="gray mt-10">Todos nuestros equipos y accesorios cuentan con la garantía BÁSICA de
                                1 año contra defectos de fabricación. </p>
                        </a> </div>

                    <div class="col-xs-12 col-sm-6 col-lg-6  left mt-20">
                        <a href="servicio-asistencia" style="color:black">
                            <div class="media">
                                <img class="mr-3" src="images/icons/servicios-03.png"
                                    alt=" Asesoría  Personalizada de Negocios">
                                <div class="media-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-lg-6  left mt-20">
                        <a href="llave-mano.php" style="color:black">
                            <div class="media">
                                <img class="mr-3" src="images/icons/servicios-04.png"
                                    alt=" Asesoría  Personalizada de Negocios">
                                <div class="media-body">
                                    <h6 class="mt-0"><strong> Autolavado Llave<br> en mano.</strong></h6>
                                </div>
                            </div>
                            <p class="gray mt-20">Si tienes un gran sueño pero no sabes como hacerlo realidad, Nosotros
                                nos ocupamos de cada detalle y te entregamos un proyecto llave en mano con ¡TODO!</p>
                        </a> </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-6 " data-aos="fade-left" data-aos-duration="3000">
                        ...
                        <p>Incorpora a tu kit de lavado nuestro sistema de reciclado de agua, que hara que reutilices
                            hasta el 90% del agua empleada en los procesos de lavado.</p>
        ...
        <section id="productos-carousel">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <p class=" text-center">
                            La mejor calidad y precio del mercado lo encuentras en nuestros equipos GreenMatik 100%
                            Mexicanos.
                        </p>
                    </div>
                    <div class="col-xs-12 col-md-2"></div>
                ...
                <div class="row mt-50 mb-50 ocultar-caracteristicas">
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-01.png" width="40"
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-02.png" width="40"
                                alt="Generic placeholder image">
                            <div class="media-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-03.png" width="40"
                                alt="Generic placeholder image">
                            <div class="media-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-04.png" width="40"
                                alt="Generic placeholder image">
                            <div class="media-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-05.png" width="40"
                                alt="Generic placeholder image">
                            <div class="media-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 mt-10">
                        <div class="media">
                            <img class=" mt-0 mr-2" src="images/icons/catalogo-06.png" width="40"
                                alt="Generic placeholder image">
                            <div class="media-body">
                ...
                <div id="owl-catalogo" class="owl-carousel wow ">
                    ...
                    <div class="item-carousel">
                        ...
                        <p class="item-description">El sistema TriPac Envidia presenta una opción totalmente
                            eléctrica,limpia ...</p>
                    ...
                    <div class="item-carousel">
                        ...
                        <p class="item-description">Unidad de alto rendimiento Compresor reciprocarte X214 Control LED
                            cabina de fácil ...</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-5">
                        ...
                        <p class="white mt-20 mb-50">Llamanos y recibe más información personalizada para iniciar tu
                            propio negocio de autolavado con la ayuda y calidad de GreenMatik.</p>
