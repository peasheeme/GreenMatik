    ...
    <section id="servicios" class="mt-70">
        <div class="container">
               ...
               <div class="row">
                   ...
                   <div class="col-xs-12 col-md-8"> <p class=" text-center">
                Bienvenidos a nuestra familia GreenMatik, donde encontraras las mejores soluciones para tu negocio, con nuestro equipo y personal de alta calidad, nosotros te llevamos de la mano en tu modelo de negocio.
                </p></div>
                   <div class="col-xs-12 col-md-2"></div>
               </div>
            <div class="row text-left services" >
                  ...
                  <a href="llave-mano.php" style="color:black">
                            ...
                            <h6 class=" servicios-margin mont" > <br>  <strong>Tu Negocio Llave en Mano</strong></h6>
                             <p class="gray">¿Buscas Invertir en un negocio rentable con recuperación de inversión en 18 meses?</p>
                     </a> </div>
                    <div class="col-xs-12 col-sm-6  col-lg-3  text-center">
                    <a href="catalogo.php" style="color:black">
                             <img src="images/icons/04.png" alt="" >
                            <h6 class=" servicios-margin mont" > <br> <strong>Autolavado para flotillas</strong></h6>
                            <p class="gray">¿Tienes una empresa de flotilla de vehículos, quieres mejorar tu productividad, ahorrar tiempos y dinero
                                ?</p>
                 </a>  </div>
            </div>
         </div>
    ...
    <section id="servicios" class="bg-gray">
        <div class="container">
               ...
               <div class="row">
                   <div class="col-xs-12 col-md-2"></div>
                   <div class="col-xs-12 col-md-8"> <p class=" text-center">
                   En GreenMatik nos interesa que tu negocio sea rentable, es por ello que nosotros te llevamos de la mano en todo el proceso de negocio y te ofrecemos los mejores equipos de México y Latinoamérica.
                </p></div>
                   <div class="col-xs-12 col-md-2"></div>
               </div>
            <div class="row text-left mt-70" >
                    <div class="col-xs-12 col-sm-6 col-lg-6  left mt-20" >
                       ...
                       <div class="media">
                            <img class="mr-3" src="images/icons/servicios-01.png" alt=" Asesoría  Personalizada de Negocios">
                     ...
                     <a href="servicio-garantias" style="color:black">
                        <div class="media">
                            <img class="mr-3" src="images/icons/servicios-02.png" alt=" Asesoría  Personalizada de Negocios">
                            <div class="media-body">
                     ...
                     <a href="servicio-asistencia" style="color:black">
                        <div class="media">
                            <img class="mr-3" src="images/icons/servicios-03.png" alt=" Asesoría  Personalizada de Negocios">
                            <div class="media-body">
                     ...
                     <a href="llave-mano.php" style="color:black">
                        <div class="media">
                            <img class="mr-3" src="images/icons/servicios-04.png" alt=" Asesoría  Personalizada de Negocios">
                            <div class="media-body">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h5><strong>El agua es un elemento imprescindible para la limpieza, pero ¡Hay que hacer un uso responsable de ella!</strong> </h5>
                 ...
                 <p>Incorpora a tu kit de lavado nuestro sistema de reciclado de agua,  que hara que reutilices hasta el 90% del agua empleada en los procesos de lavado.</p>
                ...
                <!--camiones grandes-->
                    ...
                    <a href="catalogo.php">  <img src="images/APU/APU2.jpg" alt="">
                      ...
                      <a href="catalogo.php"> <img src="images/S/prec_s700_500.jpg" alt="">
                           <h5 class="item-title mont">PRECEDENT S-700</h5> <br></a>
